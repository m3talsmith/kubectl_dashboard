...
class VolumeSetStatusView extends StatelessWidget {
  const VolumeSetStatusView({super.key, required this.status});

  final VolumeSetStatus status;
...
class VolumeSetStatusFieldHeader extends StatelessWidget {
  const VolumeSetStatusFieldHeader({super.key, required this.name, this.color});
...
class VolumeSetStatusField extends StatelessWidget {
  const VolumeSetStatusField({super.key, required this.name, required this.value, this.color, this.textColor});
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            VolumeSetStatusFieldHeader(name: name, color: textColor),
            valueWidget,
          ],
        ),
      ),
