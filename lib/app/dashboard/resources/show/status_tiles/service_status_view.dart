...
class ServiceStatusView extends StatelessWidget {
  const ServiceStatusView({super.key, required this.status});
...
class ServiceStatusFieldHeader extends StatelessWidget {
  const ServiceStatusFieldHeader({super.key, required this.name, this.color});
...
class ServiceStatusField extends StatelessWidget {
  const ServiceStatusField({super.key, required this.name, required this.value, this.color, this.textColor});
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            ServiceStatusFieldHeader(name: name, color: textColor),
            valueWidget,
          ],
        ),
      ),
