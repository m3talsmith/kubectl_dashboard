...
class EventSeriesStatusView extends StatelessWidget {
  const EventSeriesStatusView({super.key, required this.status});

  final EventSeriesStatus status;
...
class EventSeriesStatusFieldHeader extends StatelessWidget {
  const EventSeriesStatusFieldHeader({super.key, required this.name, this.color});
...
class EventSeriesStatusField extends StatelessWidget {
  const EventSeriesStatusField({super.key, required this.name, required this.value, this.color, this.textColor});
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            EventSeriesStatusFieldHeader(name: name, color: textColor),
            valueWidget,
          ],
        ),
      ),
