...
class LimitRangeStatusView extends StatelessWidget {
  const LimitRangeStatusView({super.key, required this.status});

  final LimitRangeStatus status;
...
class LimitRangeStatusFieldHeader extends StatelessWidget {
  const LimitRangeStatusFieldHeader({super.key, required this.name, this.color});
...
class LimitRangeStatusField extends StatelessWidget {
  const LimitRangeStatusField({super.key, required this.name, required this.value, this.color, this.textColor});
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            LimitRangeStatusFieldHeader(name: name, color: textColor),
            valueWidget,
          ],
        ),
      ),
