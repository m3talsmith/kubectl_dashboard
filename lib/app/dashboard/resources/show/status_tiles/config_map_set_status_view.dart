...
class ConfigMapSetStatusView extends StatelessWidget {
  const ConfigMapSetStatusView({super.key, required this.status});

  final ConfigMapSetStatus status;
...
class ConfigMapSetStatusFieldHeader extends StatelessWidget {
  const ConfigMapSetStatusFieldHeader({super.key, required this.name, this.color});
...
class ConfigMapSetStatusField extends StatelessWidget {
  const ConfigMapSetStatusField({super.key, required this.name, required this.value, this.color, this.textColor});
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            ConfigMapSetStatusFieldHeader(name: name, color: textColor),
            valueWidget,
          ],
        ),
      ),
