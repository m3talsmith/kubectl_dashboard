...
class PodStatusView extends StatelessWidget {
  const PodStatusView({super.key, required this.status});
...
class PodStatusFieldHeader extends StatelessWidget {
  const PodStatusFieldHeader({super.key, required this.name, this.color});
...
class PodStatusField extends StatelessWidget {
  const PodStatusField({super.key, required this.name, required this.value, this.color, this.textColor});
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            PodStatusFieldHeader(name: name, color: textColor),
            valueWidget,
          ],
        ),
      ),
