...
class PodDisruptionBudgetStatusView extends StatelessWidget {
  const PodDisruptionBudgetStatusView({super.key, required this.status});
...
class PodDisruptionBudgetStatusFieldHeader extends StatelessWidget {
  const PodDisruptionBudgetStatusFieldHeader({super.key, required this.name, this.color});
...
class PodDisruptionBudgetStatusField extends StatelessWidget {
  const PodDisruptionBudgetStatusField({super.key, required this.name, required this.value, this.color, this.textColor});
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            PodDisruptionBudgetStatusFieldHeader(name: name, color: textColor),
            valueWidget,
          ],
        ),
      ),
