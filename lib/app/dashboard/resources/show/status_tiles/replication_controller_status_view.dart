...
class ReplicationControllerStatusView extends StatelessWidget {
  const ReplicationControllerStatusView({super.key, required this.status});
...
class ReplicationControllerStatusFieldHeader extends StatelessWidget {
  const ReplicationControllerStatusFieldHeader({super.key, required this.name, this.color});
...
class ReplicationControllerStatusField extends StatelessWidget {
  const ReplicationControllerStatusField({super.key, required this.name, required this.value, this.color, this.textColor});
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            ReplicationControllerStatusFieldHeader(name: name, color: textColor),
            valueWidget,
          ],
        ),
      ),
