...
class EndpointsStatusView extends StatelessWidget {
  const EndpointsStatusView({super.key, required this.status});

  final EndpointsStatus status;
...
class EndpointsStatusFieldHeader extends StatelessWidget {
  const EndpointsStatusFieldHeader({super.key, required this.name, this.color});
...
class EndpointsStatusField extends StatelessWidget {
  const EndpointsStatusField({super.key, required this.name, required this.value, this.color, this.textColor});
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            EndpointsStatusFieldHeader(name: name, color: textColor),
            valueWidget,
          ],
        ),
      ),
