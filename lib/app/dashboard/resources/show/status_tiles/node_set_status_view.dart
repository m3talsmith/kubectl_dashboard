...
class NodeSetStatusView extends StatelessWidget {
  const NodeSetStatusView({super.key, required this.status});

  final NodeSetStatus status;
...
class NodeSetStatusFieldHeader extends StatelessWidget {
  const NodeSetStatusFieldHeader({super.key, required this.name, this.color});
...
class NodeSetStatusField extends StatelessWidget {
  const NodeSetStatusField({super.key, required this.name, required this.value, this.color, this.textColor});
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            NodeSetStatusFieldHeader(name: name, color: textColor),
            valueWidget,
          ],
        ),
      ),
