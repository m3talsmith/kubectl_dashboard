...
class PodSetStatusView extends StatelessWidget {
  const PodSetStatusView({super.key, required this.status});

  final PodSetStatus status;
...
class PodSetStatusFieldHeader extends StatelessWidget {
  const PodSetStatusFieldHeader({super.key, required this.name, this.color});
...
class PodSetStatusField extends StatelessWidget {
  const PodSetStatusField({super.key, required this.name, required this.value, this.color, this.textColor});
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            PodSetStatusFieldHeader(name: name, color: textColor),
            valueWidget,
          ],
        ),
      ),
