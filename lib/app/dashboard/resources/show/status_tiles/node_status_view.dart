...
class NodeStatusView extends StatelessWidget {
  const NodeStatusView({super.key, required this.status});
...
class NodeStatusFieldHeader extends StatelessWidget {
  const NodeStatusFieldHeader({super.key, required this.name, this.color});
...
class NodeStatusField extends StatelessWidget {
  const NodeStatusField({super.key, required this.name, required this.value, this.color, this.textColor});
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            NodeStatusFieldHeader(name: name, color: textColor),
            valueWidget,
          ],
        ),
      ),
