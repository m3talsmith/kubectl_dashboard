...
class PersistentVolumeClaimStatusView extends StatelessWidget {
  const PersistentVolumeClaimStatusView({super.key, required this.status});
...
class PersistentVolumeClaimStatusFieldHeader extends StatelessWidget {
  const PersistentVolumeClaimStatusFieldHeader({super.key, required this.name, this.color});
...
class PersistentVolumeClaimStatusField extends StatelessWidget {
  const PersistentVolumeClaimStatusField({super.key, required this.name, required this.value, this.color, this.textColor});
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            PersistentVolumeClaimStatusFieldHeader(name: name, color: textColor),
            valueWidget,
          ],
        ),
      ),
