...
class SecretStatusView extends StatelessWidget {
  const SecretStatusView({super.key, required this.status});
...
class SecretStatusFieldHeader extends StatelessWidget {
  const SecretStatusFieldHeader({super.key, required this.name, this.color});
...
class SecretStatusField extends StatelessWidget {
  const SecretStatusField({super.key, required this.name, required this.value, this.color, this.textColor});
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            SecretStatusFieldHeader(name: name, color: textColor),
            valueWidget,
          ],
        ),
      ),
