...
class ControllerRevisionStatusView extends StatelessWidget {
  const ControllerRevisionStatusView({super.key, required this.status});

  final ControllerRevisionStatus status;
...
class ControllerRevisionStatusFieldHeader extends StatelessWidget {
  const ControllerRevisionStatusFieldHeader({super.key, required this.name, this.color});
...
class ControllerRevisionStatusField extends StatelessWidget {
  const ControllerRevisionStatusField({super.key, required this.name, required this.value, this.color, this.textColor});
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            ControllerRevisionStatusFieldHeader(name: name, color: textColor),
            valueWidget,
          ],
        ),
      ),
