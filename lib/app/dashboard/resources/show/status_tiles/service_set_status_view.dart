...
class ServiceSetStatusView extends StatelessWidget {
  const ServiceSetStatusView({super.key, required this.status});

  final ServiceSetStatus status;
...
class ServiceSetStatusFieldHeader extends StatelessWidget {
  const ServiceSetStatusFieldHeader({super.key, required this.name, this.color});
...
class ServiceSetStatusField extends StatelessWidget {
  const ServiceSetStatusField({super.key, required this.name, required this.value, this.color, this.textColor});
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            ServiceSetStatusFieldHeader(name: name, color: textColor),
            valueWidget,
          ],
        ),
      ),
