...
class CustomResourceDefinitionStatusView extends StatelessWidget {
  const CustomResourceDefinitionStatusView({super.key, required this.status});
...
class CustomResourceDefinitionStatusFieldHeader extends StatelessWidget {
  const CustomResourceDefinitionStatusFieldHeader({super.key, required this.name, this.color});
...
class CustomResourceDefinitionStatusField extends StatelessWidget {
  const CustomResourceDefinitionStatusField({super.key, required this.name, required this.value, this.color, this.textColor});
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            CustomResourceDefinitionStatusFieldHeader(name: name, color: textColor),
            valueWidget,
          ],
        ),
      ),
