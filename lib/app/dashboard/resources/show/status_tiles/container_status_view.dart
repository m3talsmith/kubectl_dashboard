...
class ContainerStatusView extends StatelessWidget {
  const ContainerStatusView({super.key, required this.status});
...
class ContainerStatusFieldHeader extends StatelessWidget {
  const ContainerStatusFieldHeader({super.key, required this.name, this.color});
...
class ContainerStatusField extends StatelessWidget {
  const ContainerStatusField({super.key, required this.name, required this.value, this.color, this.textColor});
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            ContainerStatusFieldHeader(name: name, color: textColor),
            valueWidget,
          ],
        ),
      ),
