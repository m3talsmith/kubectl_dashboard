...
class EventSetStatusView extends StatelessWidget {
  const EventSetStatusView({super.key, required this.status});

  final EventSetStatus status;
...
class EventSetStatusFieldHeader extends StatelessWidget {
  const EventSetStatusFieldHeader({super.key, required this.name, this.color});
...
class EventSetStatusField extends StatelessWidget {
  const EventSetStatusField({super.key, required this.name, required this.value, this.color, this.textColor});
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            EventSetStatusFieldHeader(name: name, color: textColor),
            valueWidget,
          ],
        ),
      ),
