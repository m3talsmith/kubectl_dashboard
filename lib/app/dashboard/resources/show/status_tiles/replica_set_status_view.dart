...
class ReplicaSetStatusView extends StatelessWidget {
  const ReplicaSetStatusView({super.key, required this.status});
...
class ReplicaSetStatusFieldHeader extends StatelessWidget {
  const ReplicaSetStatusFieldHeader({super.key, required this.name, this.color});
...
class ReplicaSetStatusField extends StatelessWidget {
  const ReplicaSetStatusField({super.key, required this.name, required this.value, this.color, this.textColor});
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            ReplicaSetStatusFieldHeader(name: name, color: textColor),
            valueWidget,
          ],
        ),
      ),
