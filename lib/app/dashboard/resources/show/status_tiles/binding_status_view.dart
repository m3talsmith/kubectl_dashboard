...
class BindingStatusView extends StatelessWidget {
  const BindingStatusView({super.key, required this.status});
...
class BindingStatusFieldHeader extends StatelessWidget {
  const BindingStatusFieldHeader({super.key, required this.name, this.color});
...
class BindingStatusField extends StatelessWidget {
  const BindingStatusField({super.key, required this.name, required this.value, this.color, this.textColor});
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            BindingStatusFieldHeader(name: name, color: textColor),
            valueWidget,
          ],
        ),
      ),
