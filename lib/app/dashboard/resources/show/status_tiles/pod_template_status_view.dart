...
class PodTemplateStatusView extends StatelessWidget {
  const PodTemplateStatusView({super.key, required this.status});

  final PodTemplateStatus status;
...
class PodTemplateStatusFieldHeader extends StatelessWidget {
  const PodTemplateStatusFieldHeader({super.key, required this.name, this.color});
...
class PodTemplateStatusField extends StatelessWidget {
  const PodTemplateStatusField({super.key, required this.name, required this.value, this.color, this.textColor});
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            PodTemplateStatusFieldHeader(name: name, color: textColor),
            valueWidget,
          ],
        ),
      ),
