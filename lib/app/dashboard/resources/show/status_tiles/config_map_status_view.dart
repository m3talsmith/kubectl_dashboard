...
class ConfigMapStatusView extends StatelessWidget {
  const ConfigMapStatusView({super.key, required this.status});

  final ConfigMapStatus status;
...
class ConfigMapStatusFieldHeader extends StatelessWidget {
  const ConfigMapStatusFieldHeader({super.key, required this.name, this.color});
...
class ConfigMapStatusField extends StatelessWidget {
  const ConfigMapStatusField({super.key, required this.name, required this.value, this.color, this.textColor});
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            ConfigMapStatusFieldHeader(name: name, color: textColor),
            valueWidget,
          ],
        ),
      ),
