...
class VolumeStatusView extends StatelessWidget {
  const VolumeStatusView({super.key, required this.status});
...
class VolumeStatusFieldHeader extends StatelessWidget {
  const VolumeStatusFieldHeader({super.key, required this.name, this.color});
...
class VolumeStatusField extends StatelessWidget {
  const VolumeStatusField({super.key, required this.name, required this.value, this.color, this.textColor});
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            VolumeStatusFieldHeader(name: name, color: textColor),
            valueWidget,
          ],
        ),
      ),
