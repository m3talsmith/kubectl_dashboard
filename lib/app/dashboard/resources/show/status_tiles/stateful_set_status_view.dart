...
class StatefulSetStatusView extends StatelessWidget {
  const StatefulSetStatusView({super.key, required this.status});
...
class StatefulSetStatusFieldHeader extends StatelessWidget {
  const StatefulSetStatusFieldHeader({super.key, required this.name, this.color});
...
class StatefulSetStatusField extends StatelessWidget {
  const StatefulSetStatusField({super.key, required this.name, required this.value, this.color, this.textColor});
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            StatefulSetStatusFieldHeader(name: name, color: textColor),
            valueWidget,
          ],
        ),
      ),
