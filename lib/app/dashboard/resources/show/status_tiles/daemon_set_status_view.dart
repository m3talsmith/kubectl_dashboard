...
class DaemonSetStatusView extends StatelessWidget {
  const DaemonSetStatusView({super.key, required this.status});
...
class DaemonSetStatusFieldHeader extends StatelessWidget {
  const DaemonSetStatusFieldHeader({super.key, required this.name, this.color});
...
class DaemonSetStatusField extends StatelessWidget {
  const DaemonSetStatusField({super.key, required this.name, required this.value, this.color, this.textColor});
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            DaemonSetStatusFieldHeader(name: name, color: textColor),
            valueWidget,
          ],
        ),
      ),
