...
class JobStatusView extends StatelessWidget {
  const JobStatusView({super.key, required this.status});
...
class JobStatusFieldHeader extends StatelessWidget {
  const JobStatusFieldHeader({super.key, required this.name, this.color});
...
class JobStatusField extends StatelessWidget {
  const JobStatusField({super.key, required this.name, required this.value, this.color, this.textColor});
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            JobStatusFieldHeader(name: name, color: textColor),
            valueWidget,
          ],
        ),
      ),
