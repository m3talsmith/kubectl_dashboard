...
class SecretSetStatusView extends StatelessWidget {
  const SecretSetStatusView({super.key, required this.status});

  final SecretSetStatus status;
...
class SecretSetStatusFieldHeader extends StatelessWidget {
  const SecretSetStatusFieldHeader({super.key, required this.name, this.color});
...
class SecretSetStatusField extends StatelessWidget {
  const SecretSetStatusField({super.key, required this.name, required this.value, this.color, this.textColor});
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            SecretSetStatusFieldHeader(name: name, color: textColor),
            valueWidget,
          ],
        ),
      ),
